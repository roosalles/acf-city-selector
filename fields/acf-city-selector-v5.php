	...
	class acf_field_city_selector extends acf_field {
		...
		function render_field( $field ) {
			...
			if ( false !== $default_country && false == $selected_country ) {
				...
				if ( in_array( $which_fields, array( 'all', 'country_state', 'state_city' ) ) ) {
					$prefill_states = acfcs_get_states( $default_country, $show_first, $field );
				}
				if ( in_array( $which_fields, array( 'country_city', 'state_city' ) ) ) {
				...
				if ( in_array( $which_fields, array( 'all', 'country_city', 'state_city' ) ) ) {
