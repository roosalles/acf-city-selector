							...
							<form action="" method="POST">
								...
								<div class="acfcs__search-form">
									...
									<div class="acfcs__search-criteria acfcs__search-criteria--search">
										...
										<input name="acfcs_search" id="acfcs_search" type="text" value="
										<?php
										if ( false != $searched_term ) {
											echo stripslashes( $searched_term ); }
										?>
										" placeholder="<?php esc_html_e( 'City name', 'acf-city-selector' ); ?>">
									</div>
									...
									<div class="acfcs__search-criteria acfcs__search-criteria--limit">
										...
										<input name="acfcs_limit" id="acfcs_limit" type="number" value="
										<?php
										if ( false != $selected_limit ) {
											echo $selected_limit; }
										?>
										" placeholder="<?php esc_html_e( 'Limit', 'acf-city-selector' ); ?>">
									</div>
